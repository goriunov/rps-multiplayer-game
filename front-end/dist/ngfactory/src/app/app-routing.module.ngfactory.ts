...
import * as import8 from './input-name/input-name.component.ngfactory';
import * as import9 from './players-list/players-list.component.ngfactory';
import * as import10 from './game-board/game-board.component.ngfactory';
...
import * as import14 from '../../../../src/app/input-name/input-name.component';
import * as import15 from '../../../../src/app/players-list/players-list.component';
import * as import16 from '../../../../src/app/game-board/game-board.component';
import * as import17 from '@angular/core/src/application_ref';
import * as import18 from '@angular/router/src/router';
import * as import19 from '@angular/core/src/linker/ng_module_factory_loader';
...
class AppRoutingModuleInjector extends import0.NgModuleInjector<import1.AppRoutingModule> {
  ...
  constructor(parent:import7.Injector) {
    super(parent,[
      import8.InputNameComponentNgFactory,
      import9.PlayersListComponentNgFactory,
      import10.GameBoardComponentNgFactory
    ]
    ,[]);
  }
  ...
  get _LocationStrategy_4():any {
    if ((this.__LocationStrategy_4 == (null as any))) { (this.__LocationStrategy_4 = import2.provideLocationStrategy(this.parent.get(import11.PlatformLocation),this.parent.get(import12.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_3)); }
  ...
  get _NgModuleFactoryLoader_8():import6.SystemJsNgModuleLoader {
    if ((this.__NgModuleFactoryLoader_8 == (null as any))) { (this.__NgModuleFactoryLoader_8 = new import6.SystemJsNgModuleLoader(this.parent.get(import13.Compiler),this.parent.get(import6.SystemJsNgModuleLoaderConfig,(null as any)))); }
  ...
  get _ROUTES_9():any[] {
      if ((this.__ROUTES_9 == (null as any))) { (this.__ROUTES_9 = [[
        {
          path: '',
          component: import14.InputNameComponent
        }
        ,
        {
          path: 'players-list',
          component: import15.PlayersListComponent
        }
        ,
        {
          path: 'game',
          component: import16.GameBoardComponent
        }
  ...
  get _Router_10():any {
    if ((this.__Router_10 == (null as any))) { (this.__Router_10 = import2.setupRouter(this.parent.get(import17.ApplicationRef),this._UrlSerializer_6,this._RouterOutletMap_7,this._Location_5,this,this._NgModuleFactoryLoader_8,this.parent.get(import13.Compiler),this._ROUTES_9,this._ROUTER_CONFIGURATION_3)); }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import19.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_8; }
    if ((token === import20.ROUTES)) { return this._ROUTES_9; }
    if ((token === import18.Router)) { return this._Router_10; }
    if ((token === import21.ActivatedRoute)) { return this._ActivatedRoute_11; }
    if ((token === import22.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_12; }
