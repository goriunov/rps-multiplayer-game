...
class _View_PlayersListComponent0 extends import1.AppView<import3.PlayersListComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_18,'class','tag tag-pill tag-primary');
    ...
    this.renderer.setElementAttribute(this._el_24,'class','list-group');
    this._text_25 = this.renderer.createText(this._el_24,'\n      ',(null as any));
    this._el_26 = this.renderer.createElement(this._el_24,'div',(null as any));
    this.renderer.setElementAttribute(this._el_26,'class','spacing');
    this._text_27 = this.renderer.createText(this._el_26,'\n        ',(null as any));
    this._el_28 = this.renderer.createElement(this._el_26,'a',(null as any));
    this.renderer.setElementAttribute(this._el_28,'class','list-group-item ');
    this._text_29 = this.renderer.createText(this._el_28,'\n          ',(null as any));
    this._el_30 = this.renderer.createElement(this._el_28,'h4',(null as any));
    this.renderer.setElementAttribute(this._el_30,'class','list-group-item-heading');
    ...
    this._anchor_35 = this.renderer.createTemplateAnchor(this._el_24,(null as any));
    this._appEl_35 = new import2.AppElement(35,24,this,this._anchor_35);
    this._TemplateRef_35_5 = new import16.TemplateRef_(this._appEl_35,viewFactory_PlayersListComponent4);
    this._NgFor_35_6 = new import15.NgFor(this._appEl_35.vcRef,this._TemplateRef_35_5,this.parentInjector.get(import17.IterableDiffers),this.ref);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import16.TemplateRef) && (35 === requestNodeIndex))) { return this._TemplateRef_35_5; }
    if (((token === import15.NgFor) && (35 === requestNodeIndex))) { return this._NgFor_35_6; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    changes = (null as any);
    const currVal_5:any = this.context.available_players;
    if (import4.checkBinding(throwOnChange,this._expr_5,currVal_5)) {
      this._NgFor_35_6.ngForOf = currVal_5;
    ...
    const currVal_3:any = import4.interpolate(1,'',(this.context.available_players.length - 1),'');
    if (import4.checkBinding(throwOnChange,this._expr_3,currVal_3)) {
      this.renderer.setText(this._text_19,currVal_3);
      this._expr_3 = currVal_3;
    }
    const currVal_4:any = import4.interpolate(1,'',this.context.myName,'');
    if (import4.checkBinding(throwOnChange,this._expr_4,currVal_4)) {
      this.renderer.setText(this._text_31,currVal_4);
...
class _View_PlayersListComponent4 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._anchor_2 = this.renderer.createTemplateAnchor(this._el_0,(null as any));
    this._appEl_2 = new import2.AppElement(2,0,this,this._anchor_2);
    this._TemplateRef_2_5 = new import16.TemplateRef_(this._appEl_2,viewFactory_PlayersListComponent5);
    this._NgIf_2_6 = new import14.NgIf(this._appEl_2.vcRef,this._TemplateRef_2_5);
    this._text_3 = this.renderer.createText(this._el_0,'\n\n      ',(null as any));
    this._expr_0 = import7.UNINITIALIZED;
    this.init([].concat([this._el_0]),[
